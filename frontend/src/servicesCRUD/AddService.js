...
export default function AddService() {
  ...
  const onSubmit = async (e) => {
    ...
    //await axios.post("http://ccelectricalservices.eu-west-1.elasticbeanstalk.com/ccservices", ccservice);
    // Local Development URL
    await axios.post("http://localhost:8082/ccservices", ccservice);
