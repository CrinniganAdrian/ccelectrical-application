...
export default function EditService() {
  ...
  const handleFile = (file) => {
    if (file && file.type.startsWith('image/')) {
      ...
      reader.onloadend = () => {
        ...
        setCCService({ ...ccservice, imageUrl: reader.result });
      };
  ...
  const onSubmit = async (e) => {
    ...
    //await axios.put(`http://ccelectricalservices.eu-west-1.elasticbeanstalk.com/ccservices/${id}`, ccservice);
    // Local Development URL
    await axios.put(`http://localhost:8082/ccservices/${id}`, ccservice);
  ...
  const loadCCService = async () => {
    // Production URL (AWS Elastic Beanstalk)
    //const result = await axios.get(`http://ccelectricalservices.eu-west-1.elasticbeanstalk.com/ccservices/${id}`);
    // Local Development URL
    const result = await axios.get(`http://localhost:8082/ccservices/${id}`);
          ...
          <form onSubmit={(e) => onSubmit(e)}>
                  ...
                  <div className="image-preview-container">
                    ...
                    <button 
                      ...
                      onClick={() => {
                        ...
                        setCCService({ ...ccservice, imageUrl: "" });
                      }}
                    >
            ...
            <div className="d-flex gap-2 justify-content-center mt-4">
              <button type="submit" className="btn btn-success btn-lg px-4">
                <i className="fas fa-save"></i> Update Service
              </button>
